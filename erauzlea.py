...
while True:
    ...
    if (t.hour==10 or t.hour==14 or t.hour==18 or t.hour==22)and(t.minute==0):
        ...
        #### ERAUZLEA ####
        bidea_erauzle ="../MSM/" # MSM Crawler folder
        fitxategia1="zaborra/out_msm.xml"

        ## Choosen media RSS feeds ##
        RSSURLS=['https://www.berria.eus/rss/gizartea.xml',
                'https://www.berria.eus/rss/ekonomia.xml',
                'https://www.berria.eus/rss/iritzia.xml',
                'https://www.berria.eus/rss/kirola.xml',
                'https://www.berria.eus/rss/zintak.xml',
                'https://www.berria.eus/rss/politika.xml',
                'https://www.berria.eus/rss/mundua.xml',
                'https://www.berria.eus/rss/kultura.xml',
                'https://www.berria.eus/rss/bizigiro.xml',
                'https://www.naiz.eus/eu/rss/news.rss',
                'https://www.argia.eus/rss/haria',
                'https://www.eitb.eus/eu/rss/albisteak/',
                'https://zuzeu.eus/feed/',
                'https://feeds2.feedburner.com/sustatu',
                'https://www.noticiasdealava.eus/elementosInt/rss/1',
                'https://www.noticiasdenavarra.com/elementosInt/rss/1',
                'https://www.noticiasdegipuzkoa.eus/elementosInt/rss/31',
                'https://www.noticiasdegipuzkoa.eus/elementosInt/rss/1',
                'https://www.deia.eus/elementosInt/rss/99',
                'https://www.deia.eus/elementosInt/rss/22',
                'https://www.elcorreo.com/rss/2.0/?section=alava',
